...
namespace Terrexpansion.Common.UI
{
    public class CheatUI
    {
		...
		private UICheatPowersMenu _uiState;
		...
		public void Initialize() {
			_buttonTexture = ModContent.GetTexture("Terrexpansions/Assets/Cheat_Toggle");
			_buttonBorderTexture = ModContent.GetTexture("Terrexpansions/Assets/Cheat_Toggle_MouseOver");
			_itemIdsAvailableInfinitely.Clear();
			_uiState = new UICheatPowersMenu();
