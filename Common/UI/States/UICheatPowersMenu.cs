...
{
    public class UICheatPowersMenu : UIState
    {
        ...
        private enum OpenMainSubCategory
        {
            ...
            Unused2Time,
            Unused3Weather,
            Unused4EnemyStrengthSlider,
            Unused5PersonalPowers
        }
        ...
        public bool IsShowingSpawnItemsMenu => _mainCategory.CurrentOption == 2;
        ...
        private void SetupGamepadPoints(SpriteBatch spriteBatch)
        {
            ...
            {
                array5 = _helper.CreateUILinkPointGrid(ref currentID, orderedPointsByCategoryName5, _infiniteItemsWindow.GetItemsPerLine(), uILinkPoint3, array[0]);
